...
const firebaseConfig = {
  apiKey: "AIzaSyDcPULEC7wfh-7JnlMB0vlrZG4lE0c58Tk",
  authDomain: "projeto-inventario-e7002.firebaseapp.com",
  projectId: "projeto-inventario-e7002",
  storageBucket: "projeto-inventario-e7002.appspot.com",
  messagingSenderId: "369830324139",
  appId: "1:369830324139:web:4f3ec649f49652690e54ee",
  measurementId: "G-SSRNE3QF83"
};
...
function displayFilteredEquipment(filteredEquipment) {
  const equipmentSearchResult = document.getElementById('equipmentSearchResult');
  equipmentSearchResult.innerHTML = `<strong>Equipamentos encontrados:</strong> ${filteredEquipment.map(eq => eq.name).join(', ') || 'Nenhum'}`;
}
